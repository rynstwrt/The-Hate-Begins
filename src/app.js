...
import { Engine, Scene, Vector3, HemisphericLight, MeshBuilder, UniversalCamera, Color4, StandardMaterial, Color3, Texture } from "@babylonjs/core";
class App {
    constructor() {
        this.backgroundSquaresX = 5;
        this.backgroundSquaresY = 5;
        ...
        const camera = new UniversalCamera("camera", new Vector3(0, 3, -20), this.scene);
    ...
    createGround() {
        ...
        groundMat.diffuseTexture = new Texture("file:///assets/ground.jpg");
